...
const userInput: Pick<User, "email" | "username"> = {
  email: "removeVoteFromProduct-HOT@test.com",
  username: "remove-vote-from-product-HOT",
};

describe("removeVoteFromProduct mutation HOT type", () => {
    ...
    await client.mutation.voteOnProduct(
      {
        input: {
          ...
          type: UserProductVoteType[UserProductVoteType.HOT] as any,
        },
      },
      accessToken,
    );
