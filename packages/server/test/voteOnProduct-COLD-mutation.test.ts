...
const userInput: Pick<User, "email" | "username"> = {
  email: "voteOnProduct-COLD@test.com",
  username: "vote-on-product-COLD",
};

const type = UserProductVoteType[UserProductVoteType.COLD] as any;

describe("voteOnProduct mutation COLD type", () => {
