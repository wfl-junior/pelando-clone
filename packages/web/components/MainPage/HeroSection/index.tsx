...
export const HeroSection: React.FC = () => (
  <section className="bg-default-background border-default-border grid-template-areas-hero mt-4 grid grid-cols-[auto_1fr] gap-x-2 gap-y-2 rounded-sm border p-2 shadow-md lg:gap-x-8 lg:gap-y-4 lg:rounded-lg lg:p-4">
