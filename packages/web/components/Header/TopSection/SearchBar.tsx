  ...
  return (
    <Combobox
      ...
      className={classNames("md:relative md:flex-grow", {
        "bg-default-background absolute inset-x-0 z-40": open,
      })}
    >
      <div className="flex items-center gap-2 md:contents">
        ...
        <div
          className={classNames(
            "before:border-default-foreground bg-input-background relative w-full overflow-hidden rounded-full before:absolute before:inset-x-0 before:bottom-0 before:z-10 focus-within:before:border-b md:block md:animate-none",
        ...
        >
          ...
          <Combobox.Input
            type="text"
            className="text-default-foreground w-full rounded-full bg-inherit py-1.5 pr-9 pl-4 focus:outline-none"
        ...
        <Combobox.Button
          className={classNames(
            "bg-input-background flex aspect-square w-9 cursor-pointer items-center justify-center rounded-full md:absolute md:inset-y-0 md:right-1",
          ...
          <Combobox.Option
            ...
            className={({ active }) =>
              classNames(
                ...
                active ? "bg-secondary-foreground/10" : "bg-inherit",
              )
            }
          >
